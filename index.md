...
<link rel="stylesheet" href="css/style.css">
    ...
    <title>Fontana Materiales</title>
</head>
...
<body>
    <header>
        <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light px-4">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">Fontana Materiales</a>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Llamar ahora</a>
                        </li>
                    </ul>
    ...
    <article>
            <div class="logoC">
                <img src="img/logoFmACSR.png" alt="">
            </div>
    ...
    <section>
        <div class="ComoLlegar">
            <img src="img/comollegar.jpg" alt="">
        </div>
    </section>
</div>
